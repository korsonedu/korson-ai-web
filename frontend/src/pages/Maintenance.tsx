...
export const Maintenance: React.FC = () => {
  ...
  const [aiCounts, setAiCounts] = useState({ objective: 3, short: 1, essay: 1 });
  ...
  useEffect(() => { if (auditMode !== 'hub') fetchLists(); }, [qSearch, qFilterType, auditMode]);
  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-500 max-w-[1600px] mx-auto overflow-hidden text-left">
      ...
      <Tabs defaultValue="courses" onValueChange={setActiveTab} className="space-y-6 text-left">
        ...
        <TabsContent value="quizzes" className="outline-none m-0 text-left">
           <div className="max-w-4xl mx-auto space-y-6 text-left">
              <Card className="border-none shadow-sm rounded-[2rem] p-10 bg-white border border-black/[0.03] space-y-8 text-left">
